/*
  ...
  and the caret is the current reader position.
  ...
  Explanation:
    ...
    Step 2: "   -042" ('-' is read, so the result should be 
      negative)
  ...
  Output: 1337
  Explanation:
    Step 1: "1337c0d3" (no characters read because there is no 
    leading whitespace)
    Step 2: "1337c0d3" (no characters read because there is 
    neither a '-' nor '+')
    Step 3: "1337c0d3" ("1337" is read in; reading stops because 
  ...
  Explanation:
    ...
    whitespace)
    Step 2: "0-1" (no characters read because there is neither a 
    '-' nor '+')
